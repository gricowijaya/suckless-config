...
static const char *fonts[]          = { "Iosevka,Iosevka Nerd Font:size=14", "JoyPixels:pixelsize=11:antialias=true:autohint=true"};
static const char dmenufont[]       = "Iosevka,Iosevka Nerd Font:size=14";
